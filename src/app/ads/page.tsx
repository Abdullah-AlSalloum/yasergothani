    ...
    <main className="w-full min-h-screen overflow-x-hidden bg-gradient-to-b from-[#f8fafc] to-[#e2e8f0]" dir="rtl">
      ...
      <section ref={heroRef} className="relative w-full bg-[#113c56] text-white pt-11 pb-16 md:py-16 px-4 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="max-w-4xl mx-auto relative z-10 text-right flex flex-col gap-6 w-full">
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-yellow-400 font-bold text-center text-sm uppercase tracking-widest">
          ...
          <motion.button
            ...
            className="mt-2 w-full sm:w-auto sm:self-start bg-gradient-to-r from-yellow-400 to-yellow-500 text-[#113c56] font-extrabold py-3 px-10 rounded-xl text-lg shadow-xl"
          >
            ابدأ الآن
          </motion.button>
        </motion.div>
