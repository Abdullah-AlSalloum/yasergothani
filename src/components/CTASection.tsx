  ...
  <section id="calltoaction" className="py-8 px-4 md:px-12 bg-[#113c56] text-white relative overflow-hidden animate-fade-in">
    <div className="max-w-4xl mx-auto text-center">
      <div className="mb-4">
        ...
        <p className="text-lg mb-2 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>إذا شعرت أن هذا الكلام يعبّر عن واقع مشروعك، فأنت في المكان الصحيح.</p>
        <p className="text-lg mb-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>احصل على استشارة مجانية لمدة 30 دقيقة، للحصول على تحليل مبدأي للوضع الحالي مع حلول إسعافية يمكن لها أن ترفع المبيعات أو أن تقلل الهدر.</p>
      </div>
        ...
        <div className="max-w-4xl mx-auto relative" onClick={(event) => event.stopPropagation()}>
          ...
          <div className="bg-[#f5f7fb] rounded-2xl border border-[#cfd6ea] shadow-2xl overflow-hidden">
            ...
            <form className="p-4 md:p-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <div className={cardClassName}>
                <label className="block text-[#113c56] font-bold text-xl mb-2">البريد الإلكتروني <span className="text-red-500">*</span></label>
                <input
                  name="email"
                  type="email"
