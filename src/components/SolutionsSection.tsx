...
const OPEN_WEBSITES_FORM_EVENT = "open-websites-form";
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-8">
        ...
        >
          {services.map((srv, i) => {
            ...
            const isIpProtectionService = i === 1;
            const isAdsService = i === 2;
            const isWebsitesService = i === 3;
              ...
              : isIpProtectionService
                ...
                : isAdsService
                  ...
                  : isWebsitesService
                    ? "#"
                    : whatsappUrl;
            const opensInNewTab = !isGrowthService && !isIpProtectionService && !isAdsService && !isWebsitesService;
            return (
              <div
                key={i}
                id={srv.anchorId}
                ...
                <div className="w-full flex flex-col items-end mt-10">
                  ...
                  <a
                    ...
                    onClick={(event) => {
                      ...
                      } else if (isWebsitesService) {
                        event.preventDefault();
                        window.dispatchEvent(new Event(OPEN_WEBSITES_FORM_EVENT));
                      }
                    }}
