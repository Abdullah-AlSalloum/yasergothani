...
const HeroIntro: React.FC = () => (
  <section
    className="w-full min-h-[50vh] flex items-start justify-center pt-16 relative overflow-hidden"
    style={{ background: "none" }}
  >
    <img
      src="/images/lack-on-quran.jpeg"
      alt="background"
      className="absolute inset-0 w-full h-full object-cover opacity-30 pointer-events-none select-none z-0"
    />
    <div className="w-full flex flex-col items-center justify-center text-center max-w-5xl mx-auto px-8 relative z-10">
